...
import cl.duoc.levelup.catalogservice.service.CompraService;
...
public class CompraController {
    ...
    public void eliminarComprasUsuario(@PathVariable Long usuarioId) {
        compraService.eliminarComprasDeUsuario(usuarioId);
    }
}
